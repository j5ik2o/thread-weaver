...
import com.github.j5ik2o.threadWeaver.adaptor.aggregates.ShardedThreadAggregatesProxy
...
object AirframeSettings {
  ...
  def designOfAggregates(clusterSharding: ClusterSharding): Design =
    newDesign
  ...
  def design(host: String,
    ...
    com.github.j5ik2o.threadWeaver.useCase.AirframeSettings.design
      ...
      .add(designOfAggregates(clusterSharding))
