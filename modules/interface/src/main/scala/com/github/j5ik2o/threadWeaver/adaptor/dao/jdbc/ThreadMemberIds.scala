...
) extends Record with ThreadMemberIdsRecord
...
override def * : ProvenShape[ThreadMemberIdsRecordImpl] = (id,threadId,accountId,adderId,createdAt,updatedAt) <> (ThreadMemberIdsRecordImpl.tupled, ThreadMemberIdsRecordImpl.unapply)
}
