...
import com.github.j5ik2o.threadWeaver.adaptor.http.directives.MetricsDirective
  ...
  def root: Route =
    cors() {
      RouteLogging.default.httpLogRequestResult {
        ...
        } ~ getFromResourceDirectory("swagger") ~ apiMetrics { implicit traceContext =>
